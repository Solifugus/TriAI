            ...
            'AI_Agents': [
                {
                    ...
                    'Role': 'You are a loan analyst who helps with portfolio analysis, risk assessment, and lending patterns for credit union operations.',
                    'Model_API': 'ollama',
                    'Model': 'qwen2.5-coder',
                    'Polling_Interval': 3,
                    'Model_API_KEY': None  # Deprecated
                },
                {
                    'Agent': 'MemberServices',
                    'Description': 'Provides insights on member accounts, transactions, and service usage',
                    'Role': 'You are a member services specialist who helps analyze member accounts, transactions, and service patterns.',
                    'Model_API': 'ollama',
                    'Model': 'qwen2.5-coder',
                    'Polling_Interval': 3,
                    'Model_API_KEY': None  # Deprecated
                },
                {
                    ...
                    'Role': 'You are a compliance specialist who monitors regulatory requirements, audit trails, and risk management for financial institutions.',
                    'Model_API': 'anthropic',
                    'Model': 'claude-3-sonnet',
                    'Polling_Interval': 5,
                    'Model_API_KEY': 'sk-ant-mock-key-456'  # Deprecated
                },
                {
                    'Agent': 'FinancialReporter',
                    'Description': 'Generates financial reports, dashboards, and member analytics',
                    'Role': 'You are a financial reporting specialist who creates comprehensive reports, dashboards, and analytics for credit union management.',
                    'Model_API': 'openai',
                    'Model': 'gpt-4',
                    'Polling_Interval': 10,
                    'Model_API_KEY': 'sk-mock-key-123'  # Deprecated
                }
            ],
            'AI_Messages': [
                {
